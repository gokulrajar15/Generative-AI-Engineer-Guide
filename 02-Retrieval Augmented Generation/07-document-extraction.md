...
In real-world applications, documents come in many formats(PDF, DOCX, HTML, TXT, etc.) and structures(multi-column, tables, images). Extracting accurate and clean text is essential for creating meaningful embeddings and ensuring relevant retrieval.
